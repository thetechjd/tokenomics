...
const Form = ({ toggleCharts, user, email }) => {
        ...
        return (
                <>
                        {(!user.emailVerified) ? (
                                <div style={{ position: "relative", left: "50%", top: "50%", width: "500px", margin: "auto", justifyContent: "center", backgroundColor: colors.primary[600], padding: "2rem 5rem", alignItems: "center" }}>
                                ...
                                <div className="slideForm" style={{ display: "flex", flexDirection: "column", width: "75%", justifyContent: "center", backgroundColor: colors.primary[600], padding: "2rem", alignItems: "start" }} >
                                <div onClick={() => { toggleCharts("Dashboard") }} style={{ display: "flex", top: "0", right: "0", alignItem: "start", position: "absolute", justifyContent: "end", padding: "1rem", cursor: "pointer" }}>
                                ...
                                {avgSupply > 0 ? (
                                        <>
                                                {showLoading ? (
                                                        ...
                                                        <div style={{ display: "flex", flexDirection: "column", width: "100%", justifyContent: "start", textAlign: "start", marginLeft: 0 }}>
                                                                <div className='allocation' style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                                                                        <div id="bars">
                                                                                ...
                                                                                <ProgressBar completed={priv} bgColor={colors.greenAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <ProgressBar completed={avgPrivate} bgColor={colors.blueAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <p>Your public allocation of {pub}% is {pub > avgPublic ? "greater than" : "less than"} the average for similar projects.</p>
                                                                                <ProgressBar completed={pub} bgColor={colors.greenAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <ProgressBar completed={avgPublic} bgColor={colors.blueAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <p>Your team allocation of {team}% is {team > avgTeam ? "greater than" : "less than"} the average for similar projects.</p>
                                                                                <ProgressBar completed={team} bgColor={colors.greenAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <ProgressBar completed={avgTeam} bgColor={colors.blueAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                ...
                                                                                <ProgressBar completed={partners} bgColor={colors.greenAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <ProgressBar completed={avgPartners} bgColor={colors.blueAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                ...
                                                                                <ProgressBar completed={ecosystem} bgColor={colors.greenAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <ProgressBar completed={avgEcosystem} bgColor={colors.blueAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                ...
                                                                                <ProgressBar completed={company} bgColor={colors.greenAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <ProgressBar completed={avgCompany} bgColor={colors.blueAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                ...
                                                                                <ProgressBar completed={marketing} bgColor={colors.greenAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <ProgressBar completed={avgMarketing} bgColor={colors.blueAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <p>Your staking allocation of {staking}% is {staking > avgStaking ? "greater than" : "less than"} the average for similar projects.</p>
                                                                                <ProgressBar completed={staking} bgColor={colors.greenAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <ProgressBar completed={avgStaking} bgColor={colors.blueAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                ...
                                                                                <ProgressBar completed={liquidity} bgColor={colors.greenAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                                <ProgressBar completed={avgLiquidity} bgColor={colors.blueAccent[500]} baseBgColor='transparent' animateOnRender={true} transitionDuration='3s' />
                                                                ...
                                                                <p>Your <span style={{ color: colors.redAccent[400], fontWeight: "bolder", fontSize: "1.5rem" }}>token price</span> of <span style={{ fontSize: "4.5rem", fontWeight: "bolder", color: colors.greenAccent[400] }}><CountUp end={price} decimals={3} /></span>USD is

                                                                        {price > avgPrice ? (
                                                                                <span> greater than the average price of <span style={{ fontSize: "4.5rem", fontWeight: "bolder", color: colors.blueAccent[200] }}><CountUp end={avgPrice} decimals={3} /></span> USD for similar projects.</span>) :
                                                                                (
                                                                                        <span> less than the average price of ${<span style={{ fontSize: "4.5rem", fontWeight: "bolder", color: colors.blueAccent[200] }}><CountUp end={avgPrice} decimals={3} /></span>} USD for similar projects.</span>
                                                                                )}
                                                                </p>
                                                                <p>Your <span style={{ color: colors.redAccent[400], fontWeight: "bolder", fontSize: "1.5rem" }}>token supply</span> of <span style={{ fontSize: "4.5rem", fontWeight: "bolder", color: colors.greenAccent[400] }}><CountUp end={supply} /></span> is

                                                                        {supply > avgSupply ? (
                                                                                <span> greater than the average (<span style={{ fontSize: "4.5rem", fontWeight: "bolder", color: colors.blueAccent[200] }}><CountUp end={avgSupply} /></span>) for similar projects.</span>
                                                                        ) : (
                                                                                <span> less than the average <span style={{ fontSize: "4.5rem", fontWeight: "bolder", color: colors.blueAccent[200] }}>(~<CountUp end={avgSupply} />)</span> for similar projects.</span>
                                                                        )}
                                                                </p>
                                                                <p>Your <span style={{ color: colors.redAccent[400], fontWeight: "bolder", fontSize: "1.5rem" }}>market cap</span> of <span style={{ fontSize: "4.5rem", fontWeight: "bolder", color: colors.greenAccent[400] }}><CountUp end={marketCap} /></span> USD is

                                                                        {marketCap > avgMarketCap ? (
                                                                                <span> greater than the average <span style={{ fontSize: "4.5rem", fontWeight: "bolder", color: colors.blueAccent[200] }}>(~<CountUp end={avgMarketCap} />)</span> for similar projects. If either price or token supply is too high, consider reducing them to closer to the average to avoid overpricing or oversaturation.</span>
                                                                        ) : (
                                                                                <span> less than the average <span style={{ fontSize: "4.5rem", fontWeight: "bolder", color: colors.blueAccent[200] }}>(~<CountUp end={avgMarketCap} />)</span> for similar projects. If either the token price or the token supply is too low, consider increasing them to closer to the average to avoid underpricing and low FDV.</span>
                                                                        )
                                        ...
                                        <form style={{ display: "flex", width: "100%", flexDirection: "column" }}>
                                                <Box style={{ display: "flex", width: "100%", flexWrap: "wrap" }}>
                                                        <Box style={{ display: "flex", flexDirection: "column", width: "50%", alignItems: "start", justifyContent: "start" }}>
                                                        ...
                                                        <Box style={{ display: "flex", flexDirection: "column", alignItems: "start" }}>
                                                                ...
                                                                <div style={{ width: '350px', margin: "0.75rem 0", display: "flex", flexDirection: "row", alignItems: "center", gap: "2.5rem" }}>
